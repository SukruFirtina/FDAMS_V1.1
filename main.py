...
from ocr import get_text, process, cropping_selection_window
import webview
import time
import sys
import time
...
background_img = background_img.resize((1280,800), PIL.Image.ANTIALIAS)
...
select_fps = tk.OptionMenu(env.window, env.fps_variable, "0.15", "0.2", "0.5", "1", "2", "3", "4", "5")
...
button_options = tk.Button(env.window, image=reset_icon, background='black', relief=FLAT, borderwidth=0,
                         command=cropping_selection_window)
